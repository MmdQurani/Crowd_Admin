...
export default function RejectModal({ id, Alert, setAlert, setModalStatus }) {
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              <Transition.Child
                ...
                <Dialog.Panel className="w-full max-w-md transform  shadow-2xl overflow-hidden rounded-2xl  bg-white p-6 text-left align-middle rounded-lg transition-all">
                  <Dialog.Title
                    as="h3"
                    className="text-lg flex  font-medium leading-6 text-gray-800 text-start justify-between">
                    <p>آیا از رد این تراکنش مطمعن هستید !!</p>
                    <p
                      className="font-extrabold text-base cursor-pointer border-2 border-accent text-accent-600 rounded-full h-6 w-6 text-center items-center inset-0  "
                      onClick={closeModal}>
                      {' '}
                      X{' '}
                    </p>
