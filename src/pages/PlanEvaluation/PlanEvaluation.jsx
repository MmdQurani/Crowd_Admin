          ...
          <table className="table-auto  font-IRANYekanX w-full ">
            <thead className="font-normal w-full  bg-white text-sm shadow-lg   text-center text-dominant-500 ">
              <tr className="text-center ">
                <th className=" text-center  bg-secondary p-2 ">ردیف</th>
                <th className=" text-center  bg-secondary p-2 ">ارزیابی </th>
                <th className=" text-center  bg-secondary p-2 ">تاریخ ایجاد </th>
                <th className=" text-center  bg-secondary p-2 ">طرح</th>
                <th className=" text-center  bg-secondary p-2 ">زمان ایجاد طرح </th>
                <th className=" text-center  bg-secondary p-2 ">وضعیت طرح</th>
                <th className=" text-center  bg-secondary p-2 ">عملیات </th>
              </tr>
            </thead>
